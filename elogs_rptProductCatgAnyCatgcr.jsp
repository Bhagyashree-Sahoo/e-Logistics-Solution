...
<%!
Connection conn;
Statement stmtFillProductCatg, stmtFillArray;
ResultSet rsProductCatg;
String ProductCatg;
int i;
...
<head>
    ...
    <title>Order Register [ProductCatg]</title>
</head>
<script class="color">
    function showTime(){
            var dt = new Date();
...
<div id="Gradiantcolor">
    <center><br><br><br><br>
        <h2>Product Category Register &nbsp;&nbsp;&nbsp;<span style="text-transform:capitalize;">[Any Product Category]</span></h2><br><br><br>
        <form name= "f1" action="elogs_rptProductCatgAnyCatgsr.jsp"  method="GET">
            <table width="700" border="0">
                <tr> 
                    <td style="font-size:18px"><b>Select Any Product:</b></td>
                    <td>     
                        <select name="CmbProdCatg"  onchange ="call()" style="margin-top: 10px;
                        padding: 10px;
                        border-radius: 4px;
                        width: 250px;">  
                        <script>
                        ...
                        <% doConnect();
                        try{
                            stmtFillProductCatg = conn.createStatement();
                            rsProductCatg = stmtFillProductCatg.executeQuery("select * from elogs_tblprodcategory");
                            while(rsProductCatg.next()==true){
                                ProductCatg = rsProductCatg.getString("Product_Category_name");
                            %>
                            <option value = "<%=ProductCatg%>"><%=ProductCatg%></option>
                            <%
                            }
                        }
                        catch(SQLException se){
