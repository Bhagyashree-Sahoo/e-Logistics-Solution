...
<%!
Connection conn;
Statement stmtFillPCategory, stmtFillArray;
...
<head>
    ...
    <title>Order Register [PCategory]</title>
</head>
<script class="color">
    function showTime(){
            var dt = new Date();
...
<div id="Gradiantcolor">
    <center><br><br><br><br>
        <h2>Order Regsiter &nbsp;&nbsp;&nbsp;<span style="text-transform:capitalize;">[Any Product Category]</span></h2><br><br><br>
        <form name= "f1" action="elogs_rptOrderRegCatgs.jsp"  method="GET">
            <table width="700" border="0">
                <tr> 
                    <td style="font-size:18px"><b>Select Product Category:</b></td>
                    <td>     
                        <select name="cmbPcatg"  onchange ="call()" style="margin-top: 10px;
                        padding: 10px;
                        border-radius: 4px;
                        width: 250px;">  
                        <script>
                        ...
                        <% doConnect();
                        try{
                            stmtFillPCategory = conn.createStatement();
                            rsPCategory = stmtFillPCategory.executeQuery("select * from elogs_tblproductinfo");
                            while(rsPCategory.next()==true){
                                PCategory = rsPCategory.getString("Product_category_name");
                            %>
