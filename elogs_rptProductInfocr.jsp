...
<%!
Connection conn;
Statement stmtFillPName, stmtFillArray;
ResultSet rsPName;
String Pname;
int i;
...
<head>
    ...
    <title>Detail Report Stock Regsiter</title>
</head>
<script class="color">
    function showTime(){
            var dt = new Date();
...
<div id="Gradiantcolor">
    <center><br><br><br><br>
        <h2>Stock Report &nbsp;&nbsp;&nbsp;<span style="text-transform:capitalize;">[Any Category]</span></h2><br><br><br>
        <form name= "f1" action="elogs_rptProductInfosr.jsp"  method="GET">
            <table width="700" border="0">
                <tr> 
                    <td style="font-size:18px"><b>Select Product Category Name:</b></td>
                    <td>     
                        <select name="cmbPName"  onchange ="call()" style="margin-top: 10px;
                        padding: 10px;
                        border-radius: 4px;
                        width: 250px;">  
                        <script>
                        ...
                        <% doConnect();
                        try{
                            stmtFillPName = conn.createStatement();
                            rsPName = stmtFillPName.executeQuery("select * from elogs_tblprodcategory");
                            while(rsPName.next()==true){
                                Pname = rsPName.getString("Product_Category_name");
                            %>
