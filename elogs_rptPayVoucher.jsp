...
Statement stmtData;
ResultSet rsData;
String Voucherno,VIssuedate,Sname,Regno,Locality,City,Stateunion,Paymentmode,PayRefNo,Date,Bankname,Amount;
int slno;
...
<!-- Header -->
    ...
    <nav>
        ...
        <div class = "logo">
            <h4><center><a href="adminmenu.html" style="color: white; text-decoration: none; align-items: center;letter-spacing: 0.5rem;"><span>Creditors Ledger</span></a> </center></h4> 
        </div>
...
try{
    ...
    rsData = stmtData.executeQuery("select * from elogs_tblpaymentvoucher");
    slno = 1;
    while(rsData.next()){
        Voucherno = rsData.getString("Voucher_no");
        VIssuedate = rsData.getString("VIssue_date");
        ...
        PayRefNo = rsData.getString("Payment_ref_no");
