...
<head>
    ...
    <title>Issue Register [RName] </title>
...
<!-- Header -->
    <nav>
        ...
        <div class = "logo">
            <h4><center><a href="adminmenu.html" style="color: white; text-decoration: none; align-items: center;letter-spacing: 0.1rem;"><span>Issue Register <br> [<%= demo %>]</span></a> </center></h4> 
        </div>
...
try{
    ...
    demo=request.getParameter("cmbRName");
    rsData = stmtData.executeQuery("select * from elogs_tblissue where Retailer_name = '"+demo+"'");    
    slno = 1;
    while(rsData.next()){
...
<input type="button" name="btmBack" class="button button3" value="Back" onclick="window.location.href = 'elogs_rptIssueRetailerNamec.jsp';">
</center>
