...
Statement stmtData;
ResultSet rsData;
String Orno,SupCode,ProductCatgName,ProductCatgCode,ProductCode,ProductName,Feature,PurchasePrice,MRP,GSTSlab,Stock,Unit,Location,demo;
int slno;
...
<input type="button" name="btmBack" class="button button3" value="Back" onclick="window.location.href = 'elogs_rptProductInfoAnySupcr.jsp';">
</center>
