...
<head>
    ...
    <title>Purchase Register [Indate]</title>
</head>
<script class="color">
    function showTime(){
            var dt = new Date();
...
<div id="Gradiantcolor">
    <center><br><br><br><br>
        <h2>Purchase Regsiter &nbsp;&nbsp;&nbsp;<span style="text-transform:capitalize;">[Any Date]</span></h2><br><br><br>
        <form name= "f1" action="elogs_rptPurchaseRegIndates.jsp"  method="GET">
            <table width="700" border="0">
                <tr> 
                    <td style="font-size:18px"><b>Select Invoice Date:</b></td>
                    <td>     
                        <select name="cmbIndate"  onchange ="call()" style="margin-top: 10px;
                        padding: 10px;
                        border-radius: 4px;
                        width: 250px;">  
                        <script>
                        ...
                        try{
                            ...
                            rsIndate = stmtFillInvoicedate.executeQuery("select * from elogs_tblpurchase");
                            while(rsIndate.next()==true){
                                Indate = rsIndate.getString("Invoice_date");
                            %>
