...
Statement stmtData;
ResultSet rsData;
String Ino,Idate,Orno,Ordate,Supname,Locality,City,State_union,PurType,Prodname,Catg,Price,Qty,Amt,disper,disamt,gstper,gstamt,netamt,demo;
int slno;
...
try{
    ...
    demo=request.getParameter("cmbPCode");
    rsData = stmtData.executeQuery("select * from elogs_tblpurchase where Product_code = '"+demo+"'");    
    slno = 1;
    while(rsData.next()){
...
<input type="button" name="btmBack" class="button button3" value="Back" onclick="window.location.href = 'elogs_rptPurchaseRegPcodec.jsp';">
</center>
