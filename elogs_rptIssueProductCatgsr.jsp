...
Statement stmtData;
ResultSet rsData;
String Ino,Idate,Orno,Ordate,Retailername,Locality,City,State_union,PurType,Prodcode,Prodname,Price,Qty,Amt,disper,disamt,gstper,gstamt,netamt,demo;
int slno;
HttpSession ssn;
String retname;
...
<head>
    ...
    <title>Purchase Register [PCATEGORY] </title>
...
<body>
    <%
    demo=request.getParameter("cmbPcatg");
    %>
...
<!-- Header -->
    <nav>
        ...
        <div class = "logo">
            <h4><center><a href="usermenu.jsp" style="color: white; text-decoration: none; align-items: center;letter-spacing: 0.1rem;"><span>Issue Report [<%= demo %>]</span></a> </center></h4> 
        </div>
...
try{
    ...
    demo=request.getParameter("cmbPcatg");
    rsData = stmtData.executeQuery("select * from elogs_tblissue where Retailer_name = '"+retname+"' and Category = '"+demo+"'");    
    slno = 1;
    while(rsData.next()){
...
<input type="button" name="btmBack" class="button button3" value="Back" onclick="window.location.href = 'elogs_rptIssueProductCatgcr.jsp';">
</center>
