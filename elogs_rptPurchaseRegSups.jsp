...
Statement stmtData;
ResultSet rsData;
String invoiceno,invoicedate,Orno,Ordate,code,Locality,City,State_union,Prodcode,Prodname,Catg,Price,Qty,Amt,disper,disamt,gstper,gstamt,netamt,demo;
int slno;
...
<!-- Header -->
    <nav>
        ...
        <div class = "logo">
            <h4><center><a href="adminmenu.html" style="color: white; text-decoration: none; align-items: center;letter-spacing: 0.1rem;"><span>Purchase Register [<%= demo %>]</span></a> </center></h4> 
        </div>
...
try{
    ...
    demo=request.getParameter("cmbSName");
    rsData = stmtData.executeQuery("select * from elogs_tblpurchase where Supplier_name = '"+demo+"'");    
    slno = 1;
    while(rsData.next()){
        invoiceno = rsData.getString("Purchase_invoice_no");
...
<input type="button" name="btmBack" class="button button3" value="Back" onclick="window.location.href = 'elogs_rptPurchaseRegSupc.jsp';">
</center>
