...
String InvoiceNo,SerialNo,InvoiceNo_SerialNo,SInvoiceDate[],SOrderNo[],SOrderDate[],SRetailerName[],SLocality[],SCity[],SStateUnion[],SPurchaseType[],SSerialNo[],SProductCode[],SProductName[],SCategory[],SPrice[],SQuantity[],SAmount[],SDisPercentage[],SDisAmount[],SGSTPer[],SGSTAmount[],SNetAmount[];
String PrevQty;
int i;
...
try{
    ...
    rsFillPurchaseGoodData = stmtFillArrayPurchaseGoodData.executeQuery("Select * from elogs_tblissue");
    ...
    while(rsFillPurchaseGoodData.next()==true){
        ...
        SRetailerName[i]= rsFillPurchaseGoodData.getString("Retailer_name");
...
<script class="color">
    ...
    function GetAllIssueGoodData(){
            ...
            %>
                ...
                document.f1.txtRetailName.value = JSRetailerName[k-1];
...
<div id="Gradiantcolor">
    <center><br><br><br>
        ...
        <form name= "f1" action="elogs_Issuefs.jsp"  method="GET">
            <table width="800" border="0">
                <tr>
                    <tr>
                        <td style="font-size:17px"><b>Invoice No :</b> </td>
                        <td>
                            <select name="cmbInvoiceNo" onchange="GetAllIssueGoodData()" style="width: 230px">  
                            <option value="null" >--Invoice/SerialNo--</option>    
                            <% doConnect();
                            try{
                                stmtFillInvoiceNo = conn.createStatement();
                                rsInvoiceNo= stmtFillInvoiceNo.executeQuery("select * from elogs_tblissue");
                                while(rsInvoiceNo.next()==true){
                                    InvoiceNo = rsInvoiceNo.getString("Invoice_no");
                    ...
                    <tr>
                        ...
                        <td><select name="cmbOrderNo" onchange="FillOrderData()" style="width: 230px">  
                            ...
                            try{
                                ...
                                rsOrderNo= stmtFillOrderNo.executeQuery("select * from elogs_tblissue");
                ...
                <tr>
                    ...
                    <td><input type="text" name="txtRetailName" size="10" placeholder="Enter Retailer Name...." ></td>
                </tr>
                <tr>
            ...
            <br><br>
            <br>
            <input type="Submit" id="btnup"name="btnUpdate" class="button button1" value="Update" disabled>
             <input type="Submit" id="btndelete"name="btnDelete" class="button button2" value="Delete" disabled >
             <input type="button" name="btmBack" class="button button3" value="Back" onclick="window.location.href = 'elogs_Issuec.jsp';">
        </form>
         <h4>
        </center>      
</div>
