...
try{
    ...
    demo=request.getParameter("cmbPCode");
    rsData = stmtData.executeQuery("select * from elogs_tblissue where Product_code = '"+demo+"'");    
    slno = 1;
    while(rsData.next()){
...
<input type="button" name="btmBack" class="button button3" value="Back" onclick="window.location.href = 'elogs_rptIssueProductCodec.jsp';">
</center>
