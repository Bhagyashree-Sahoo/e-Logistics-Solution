...
<div id="Gradiantcolor">
    <center><br><br><br>
        ...
        <form name= "f1" action="elogs_RetailOrdersr.jsp"  method="GET">
            <table width="800" border="0">
                <tr>
                    <tr>
                        <td style="font-size:17px"><b>Order No :</b> </td>
                        <td><input type="text" name="txtOrderNo" placeholder="Enter Order No.." autocomplete="off" value="<%= retailorder %>"required readonly></td>
            ...
            <input type="submit" name="btmSubmit" class="button button1" value="Submit">
             <input type="button" name="btmFind" class="button button2" value="Find" onclick="window.location.href = 'elogs_RetailOrderfcr.jsp';">
