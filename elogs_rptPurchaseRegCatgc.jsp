...
<div id="Gradiantcolor">
    <center><br><br><br><br>
        <h2>Purchase Regsiter &nbsp;&nbsp;&nbsp;<span style="text-transform:capitalize;">[Any Product Category]</span></h2><br><br><br>
        <form name= "f1" action="elogs_rptPurchaseRegCatgs.jsp"  method="GET">
                ...
                <tr> 
                    ...
                    <td>     
                        ...
                        try{
                            ...
                            rsPCategory = stmtFillPCategory.executeQuery("select * from elogs_tblprodcategory");
