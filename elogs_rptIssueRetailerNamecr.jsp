...
<%!
Connection conn;
Statement stmtFillRName, stmtFillArray;
ResultSet rsRName;
String Retailername;
HttpSession ssn;
String retname;
...
<head>
    ...
    <title>Issue Register [Retailername]</title>
</head>
<script class="color">
    function showTime(){
            var dt = new Date();
...
<div id="Gradiantcolor">
    <center><br><br><br><br>
        <h2>Issue Regsiter &nbsp;&nbsp;&nbsp;<span style="text-transform:capitalize;">[Any Retailer Name]</span></h2><br><br><br>
        <form name= "f1" action="elogs_rptIssueRetailerNamesr.jsp"  method="GET">
            <table width="700" border="0">
                <tr> 
                    <td style="font-size:18px"><b>Select Retailer Name:</b></td>
                    <td>     
                        <select name="cmbRName"  onchange ="call()" style="margin-top: 10px;
                        padding: 10px;
                        border-radius: 4px;
                        width: 250px;">  
                        <script>
                        ...
                        try{
                            ...
                            rsRName = stmtFillRName.executeQuery("select * from elogs_tblretailer where Retailer_name = '"+retname+"'");
                            while(rsRName.next()==true){
                                Retailername = rsRName.getString("Retailer_name");
                            %>
