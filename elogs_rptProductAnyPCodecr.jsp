...
<%!
Connection conn;
Statement stmtFillProductCode, stmtFillArray;
ResultSet rsProductCode;
String ProductCode;
int i;
...
<head>
    ...
    <title>Product Code Register [Any Product Code]</title>
</head>
<script class="color">
    function showTime(){
            var dt = new Date();
...
<div id="Gradiantcolor">
    <center><br><br><br><br>
        <h2>Product Code Register &nbsp;&nbsp;&nbsp;<span style="text-transform:capitalize;">[Any Product Code]</span></h2><br><br><br>
        <form name= "f1" action="elogs_rptProductAnyPCodesr.jsp"  method="GET">
            <table width="700" border="0">
                <tr> 
                    ...
                    <td>     
                        ...
                        <% doConnect();
                        try{
                            stmtFillProductCode = conn.createStatement();
                            rsProductCode = stmtFillProductCode.executeQuery("select * from elogs_tblproductinfo");
                            while(rsProductCode.next()==true){
