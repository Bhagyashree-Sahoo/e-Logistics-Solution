...
<%!
Connection conn;
Statement stmtFillPCatg, stmtFillArray;
ResultSet rsPCatg;
String PCatg;
int i;
...
<head>
    ...
    <title>Order Register Product Category</title>
</head>
<script class="color">
    function showTime(){
            var dt = new Date();
...
<div id="Gradiantcolor">
    <center><br><br><br><br>
        ...
        <form name= "f1" action="elogs_rptOrderRegPCatgsr.jsp"  method="GET">
            <table width="700" border="0">
                <tr> 
                    ...
                    <td>     
                        ...
                        <% doConnect();
                        try{
                            stmtFillPCatg = conn.createStatement();
                            rsPCatg = stmtFillPCatg.executeQuery("select * from elogs_tblprodcategory");
                            while(rsPCatg.next()==true){
                                PCatg = rsPCatg.getString("Product_Category_name");
                            %>
                            <option value = "<%=PCatg%>"><%=PCatg%></option>
                            <%
                            }
                        }
                        catch(SQLException se){
