...
<nav>
    ...
    <div class = "logo">
        <h4><center><a href="adminmenu.html" style="color: white; text-decoration: none; align-items: center;letter-spacing: 0.5rem;"><span>Issue Register</span></a> </center></h4> 
    </div>
...
try{
    ...
    rsData = stmtData.executeQuery("select * from elogs_tblissue"); 
    slno = 1;
    while(rsData.next()){
