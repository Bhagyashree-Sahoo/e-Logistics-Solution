...
<head>
    ...
    <title>Payment Voucher [Supplier Name]</title>
</head>
<script class="color">
    function showTime(){
            var dt = new Date();
...
<div id="Gradiantcolor">
    <center><br><br><br><br>
        <h2>Payment Voucher &nbsp;&nbsp;&nbsp;<span style="text-transform:capitalize;">[Any Supplier]</span></h2><br><br><br>
        <form name= "f1" action="elogs_rptPayVoucherSupps.jsp"  method="GET">
            <table width="700" border="0">
                <tr> 
                    <td style="font-size:18px"><b>Select Supplier Name : </b></td>
                    <td>     
                        ...
                        try{
                            ...
                            rsSuppname = stmtFillSupplierName.executeQuery("select * from supplierinformation");
                            while(rsSuppname.next()==true){
                                Supname = rsSuppname.getString("SupplierName");
                            %>
