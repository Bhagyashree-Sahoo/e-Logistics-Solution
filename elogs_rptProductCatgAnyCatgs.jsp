...
Statement stmtData;
ResultSet rsData;
String Orno,SupCode,SupplierName,ProductCatgCode,ProductCode,ProductName,Feature,PurchasePrice,MRP,GSTSlab,Stock,Unit,Location,demo;
int slno;
...
<body>
    <%
    demo=request.getParameter("CmbProdCatg");
    %>
...
<!-- Header -->
    ...
    <nav>
        ...
        <div class = "logo">
            <h4><center><a href="adminmenu.html" style="color: white; text-decoration: none; align-items: center;letter-spacing: 0.1rem;"><span>Product Information Register [<%= demo %>]</span></a> </center></h4> 
        </div>
...
try{ 
    ...
    demo=request.getParameter("CmbProdCatg");
    rsData = stmtData.executeQuery("select * from elogs_tblproductinfo where Product_category_name = '"+demo+"'");    
    slno = 1;
    while(rsData.next()){
...
<input type="button" name="btmBack" class="button button3" value="Back" onclick="window.location.href = 'elogs_rptProductCatgAnyCatgc.jsp';">
</center>
