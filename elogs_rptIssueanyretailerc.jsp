...
<%!
Connection conn;
Statement stmtFillRetailer, stmtFillArray;
ResultSet rsRetailer;
String Retailername;
int i;
...
<head>
    ...
    <title>Order Register [Retailername]</title>
</head>
<script class="color">
    function showTime(){
            var dt = new Date();
...
<div id="Gradiantcolor">
    <center><br><br><br><br>
        <h2>Issue Regsiter &nbsp;&nbsp;&nbsp;<span style="text-transform:capitalize;">[Any Retailer]</span></h2><br><br><br>
        <form name= "f1" action="elogs_rptOrderRegCatgs.jsp"  method="GET">
            <table width="700" border="0">
                <tr> 
                    <td style="font-size:18px"><b>Select Any Retailer:</b></td>
                    <td>     
                        ...
                        <% doConnect();
                        try{
                            stmtFillRetailer = conn.createStatement();
                            rsRetailer = stmtFillRetailer.executeQuery("select * from elogs_tblretailer");
                            while(rsRetailer.next()==true){
                                Retailername = rsRetailer.getString("Retailer_name");
                            %>
