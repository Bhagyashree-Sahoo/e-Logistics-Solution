...
Statement stmtData;
ResultSet rsData;
String Ino,Idate,Orno,Ordate,Retailername,Locality,City,State_union,PurType,Prodcode,Prodname,Category,Price,Qty,Amt,disper,disamt,gstper,gstamt,netamt,datefrom,dateto;
int slno;
...
<!-- Header -->
    <nav>
        ...
        <div class = "logo">
            <h4><center><a href="adminmenu.html" style="color: white; text-decoration: none; align-items: center;letter-spacing: 0.1rem;"><span>Purchase Register [<%= datefrom %>] - [<%= dateto %>]</span></a> </center></h4> 
        </div>
...
try{
    ...
    datefrom=request.getParameter("cmbIndatefrom");
    dateto = request.getParameter("cmbIndateto");
    rsData = stmtData.executeQuery("select * from elogs_tblissue where Invoice_date >= '"+datefrom+"' and  Invoice_date <= '"+dateto+"'");    
    slno = 1;
    while(rsData.next()){
...
<input type="button" name="btmBack" class="button button3" value="Back" onclick="window.location.href = 'elogs_rptIssueInvoiceDatec.jsp';">
</center>
