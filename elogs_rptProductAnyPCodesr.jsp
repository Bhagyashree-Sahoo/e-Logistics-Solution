...
<!-- Header -->
    <nav>
        ...
        <div class = "logo">
            <h4><center><a href="usermenu.jsp" style="color: white; text-decoration: none; align-items: center;letter-spacing: 0.1rem;"><span>Product Code Register [<%= demo %>]</span></a> </center></h4> 
        </div>
...
<input type="button" name="btmBack" class="button button3" value="Back" onclick="window.location.href = 'elogs_rptProductAnyPCodecr.jsp';">
</center>
