...
Statement stmtData;
ResultSet rsData;
String Ino,Idate,Orno,Ordate,Supname,Locality,City,State_union,PurType,Prodcode,Prodname,Price,Qty,Amt,disper,disamt,gstper,gstamt,netamt,demo;
int slno;
...
try{
    ...
    demo=request.getParameter("cmbPcatg");
    rsData = stmtData.executeQuery("select * from elogs_tblpurchase where Category = '"+demo+"'");    
    slno = 1;
    while(rsData.next()){
...
<input type="button" name="btmBack" class="button button3" value="Back" onclick="window.location.href = 'elogs_rptPurchaseRegCatgc.jsp';">
</center>
