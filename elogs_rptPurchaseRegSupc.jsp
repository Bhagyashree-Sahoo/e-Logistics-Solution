...
<head>
    ...
    <title>Purchase Register [Supplier]</title>
</head>
<script class="color">
    function showTime(){
            var dt = new Date();
...
<div id="Gradiantcolor">
    <center><br><br><br><br>
        <h2>Purchase Regsiter &nbsp;&nbsp;&nbsp;<span style="text-transform:capitalize;">[Any Supplier]</span></h2><br><br><br>
        <form name= "f1" action="elogs_rptPurchaseRegSups.jsp"  method="GET">
