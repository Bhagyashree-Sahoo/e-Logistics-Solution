...
<nav>
        ...
        <div class = "logo">
            <h4><center><a href="usermenu.jsp" style="color: white; text-decoration: none; align-items: center;letter-spacing: 0.1rem;"><span> Order Report [<%= demo %>]</span></a> </center></h4> 
        </div>
...
try{
    ...
    demo=request.getParameter("cmbPCatg");
    rsData = stmtData.executeQuery("select * from elogs_tblretailorder where Category = '"+demo+"' and Retailer_name = '"+retname+"'");    
    slno = 1;
    while(rsData.next()){
...
<input type="button" name="btmBack" class="button button3" value="Back" onclick="window.location.href = 'elogs_rptOrderRegPCatgcr.jsp';">
</center>
