...
Statement stmtData;
ResultSet rsData;
String PInvoiceno,Invoicedate,Orderno,Orderdate,Suppliername,Locality,City,Stateunion,Purchasetype,Serialno,Productcode,Productname,Catg,Price,Qty,Amount,DisPer,DisAmount,GSTPer,GSTAmount,Netamount;
int slno;
...
<!-- Header -->
    <nav>
        ...
        <div class = "logo">
            <h4><center><a href="adminmenu.html" style="color: white; text-decoration: none; align-items: center;letter-spacing: 0.5rem;"><span>Purchase Register</span></a> </center></h4> 
        </div>
...
try{
    ...
    rsData = stmtData.executeQuery("select * from elogs_tblpurchase"); 
    slno = 1;
    while(rsData.next()){
        PInvoiceno = rsData.getString("Purchase_invoice_no");
