...
ResultSet rsData;
HttpSession ssn;
String Orno,Ordate,retailername,code,Locality,City,State_union,Slno,Prodcode,Prodname,Catg,MRP,Qty,Amt;
int slno;
String retname;
...
<head>
    ...
    <title>Retailer Order Report </title>
...
<nav>
    ...
    <div class = "logo">
        <h4><center><a href="adminmenu.html" style="color: white; text-decoration: none; align-items: center;letter-spacing: 0.5rem;"><span>Retailer Order Report</span></a> </center></h4> 
    </div>
...
try{
    ...
    rsData = stmtData.executeQuery("select * from elogs_tblretailorder where Retailer_name = '"+retname+"'");    
    slno = 1;
    while(rsData.next()){
