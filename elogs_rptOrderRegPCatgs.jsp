...
<nav>
        ...
        <div class = "logo">
            <h4><center><a href="adminmenu.html" style="color: white; text-decoration: none; align-items: center;letter-spacing: 0.1rem;"><span> Order Report [<%= demo %>]</span></a> </center></h4> 
        </div>
...
try{
    ...
    demo=request.getParameter("cmbPCatg");
    rsData = stmtData.executeQuery("select * from elogs_tblretailorder where Category = '"+demo+"'");    
    slno = 1;
    while(rsData.next()){
...
<input type="button" name="btmBack" class="button button3" value="Back" onclick="window.location.href = 'elogs_rptOrderRegPCatgc.jsp';">
</center>
