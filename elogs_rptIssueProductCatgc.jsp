...
<head>
    ...
    <title>Issue Register [PCategory]</title>
</head>
<script class="color">
    function showTime(){
            var dt = new Date();
...
<div id="Gradiantcolor">
    <center><br><br><br><br>
        <h2>Issue Regsiter &nbsp;&nbsp;&nbsp;<span style="text-transform:capitalize;">[Any Product Category]</span></h2><br><br><br>
        <form name= "f1" action="elogs_rptIssueProductCatgs.jsp"  method="GET">
