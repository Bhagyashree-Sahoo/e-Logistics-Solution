...
try{
    ...
    rsRetailercode = stmtFillArray1.executeQuery("SELECT MAX(Retailer_code) as retailercode FROM elogs_tblretailer");
    if(rsRetailercode.next()){
        rcode=rsRetailercode.getString("retailercode");
	...
	srslno = rcode.substring(rcode.indexOf('2'));
...
<head>
    ...
    <title>Retailer Information 2</title>
</head>
<script class="color">
    function showTime(){
            var dt = new Date();
...
<div id="Gradiantcolor">
    <center><br><br>
        ...
        <form name= "f1" action="elogs_retailers.jsp"  method="GET" >
            <table width="850" border="0">
                <tr>
                    <td><b>Retailer Code :</b></td>
                    <td><input type="text" name="txtRCode" size="32" autocomplete="off" value="<%= rcode %>" readonly></td>
                    <td rowspan="5" align="right">

                    <!-- //imageshow code// -->
                    <img name="imgPhoto" src="download2.svg" width="150" height="150" style="border-radius:75px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <!-- Image Collected -->
                    <td><b>Photo :</b></td>
                    <td><input type="file" name="filePhoto" size="32" onchange="showPhoto()"></td>
                </tr>
                <tr>
                    <td><b>G.S.T. No. :</b></td>
                ...
                <tr>
                    ...
                    <td><b>Website :</b></td>
                    <td><input type="url" name="txtWebsite" size="32" placeholder="Enter your Website.."></td>
                </tr>
            </table>
            </table><br><br>
            <br>
            <input type="submit" name="btmsub" class="button button1" value="Submit">
             <input type="submit" name="btmfind" class="button button2" value="Find" onclick="window.location.href = 'elogs_retailerfc.jsp';">
             <input type="reset" name="btmres" class="button button3" value="Reset" onclick="clearImage()">
        </form>
         <h4>
        </center>      
</div>
