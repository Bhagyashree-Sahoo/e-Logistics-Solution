...
<head>
    ...
    <title>Issue Register [Indate]</title>
</head>
<script class="color">
    function showTime(){
            var dt = new Date();
...
<div id="Gradiantcolor">
    <center><br><br><br><br>
        <h2>Issue Regsiter &nbsp;&nbsp;&nbsp;<span style="text-transform:capitalize;">[Any Date]</span></h2><br><br><br>
        <form name= "f1" action="elogs_rptIssueInvoiceDatesr.jsp"  method="GET">
                ...
                <tr> 
                    ...
                    <td>     
                        ...
                        try{
                            ...
                            rsIndate = stmtFillInvoicedate.executeQuery("select * from elogs_tblissue where Retailer_name = '"+retname+"'");
