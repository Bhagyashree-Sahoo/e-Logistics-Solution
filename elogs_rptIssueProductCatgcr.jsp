...
<div id="Gradiantcolor">
    <center><br><br><br><br>
        ...
        <form name= "f1" action="elogs_rptIssueProductCatgsr.jsp"  method="GET">
                ...
                <tr> 
                    ...
                    <td>     
                        ...
                        try{
                            ...
                            rsPCategory = stmtFillPCategory.executeQuery("select * from elogs_tblissue where Retailer_name = '"+retname+"'");
