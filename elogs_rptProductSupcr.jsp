...
<%!
Connection conn;
Statement stmtFillSName, stmtFillArray;
ResultSet rsSName;
String Sname;
int i;
...
<div id="Gradiantcolor">
    <center><br><br><br><br>
        <h2>Stock Register &nbsp;&nbsp;&nbsp;<span style="text-transform:capitalize;">[Any Supplier]</span></h2><br><br><br>
        <form name= "f1" action="elogs_rptProductSupsr.jsp"  method="GET">
            <table width="500" border="0">
                <tr>
                    <td style="font-size:18px"><b>Select Supplier Name:</b></td>
                    <td>              
                        <select name="cmbSName" style="margin-top: 10px;
                        padding: 10px;
                        border-radius: 4px;
                        width: 250px;">  
            ...
            <input type="submit" class="button button1" value="Submit">
             <input type="submit" name="" class="button button3" value="Reset">
        </form>
         <h4>
        </center>      
</div>
