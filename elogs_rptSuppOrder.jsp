...
Statement stmtData;
ResultSet rsData;
String Orno,Ordate,Supname,code,Locality,City,State_union,Slno,Prodcode,Prodname,Catg,Price,Qty,Amt;
int slno;
...
<!-- Header -->
    <nav>
        ...
        <div class = "logo">
            <h4><center><a href="adminmenu.html" style="color: white; text-decoration: none; align-items: center;letter-spacing: 0.5rem;"><span>Supplier Order Report</span></a> </center></h4> 
        </div>
...
try{
    ...
    rsData = stmtData.executeQuery("select * from elogs_tblsupporder");    
    slno = 1;
    while(rsData.next()){
