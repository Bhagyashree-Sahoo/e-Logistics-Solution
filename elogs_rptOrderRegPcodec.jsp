...
<head>
    ...
    <title>Order Register [PCODE]</title>
</head>
<script class="color">
    function showTime(){
            var dt = new Date();
...
<div id="Gradiantcolor">
    <center><br><br><br><br>
        <h2>Order Regsiter &nbsp;&nbsp;&nbsp;<span style="text-transform:capitalize;">[Any Product Code]</span></h2><br><br><br>
        <form name= "f1" action="elogs_rptOrderRegPcodes.jsp"  method="GET">
