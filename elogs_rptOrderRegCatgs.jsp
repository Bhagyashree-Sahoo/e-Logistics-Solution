...
Statement stmtData;
ResultSet rsData;
String Orno,Ordate,Supname,code,Locality,City,State_union,Slno,Prodcode,Prodname,Price,Qty,Amt,demo;
int slno;
...
<!-- Header -->
    <nav>
        <div class = "logo">
            <h4><center>Order Register [<%= demo %>]</center></h4>
        </div>
    </nav>
...
try{
    ...
    demo=request.getParameter("cmbPcatg");
    rsData = stmtData.executeQuery("select * from elogs_tblsupporder where Category = '"+demo+"'");    
    slno = 1;
    while(rsData.next()){
...
<input type="button" name="btmBack" class="button button3" value="Back" onclick="window.location.href = 'elogs_rptOrderRegCatgc.jsp';">
</center>
