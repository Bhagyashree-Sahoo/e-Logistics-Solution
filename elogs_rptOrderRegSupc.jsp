...
<div id="Gradiantcolor">
    <center><br><br><br><br>
        <h2>Order Regsiter &nbsp;&nbsp;&nbsp;<span style="text-transform:capitalize;">[Any Supplier]</span></h2><br><br><br>
        <form name= "f1" action="elogs_rptOrderRegSups.jsp"  method="GET">
            <table width="700" border="0">
                <tr> 
                    <td style="font-size:18px"><b>Select Supplier Name:</b></td>
                    <td>     
                        <select name="cmbSName"  onchange ="call()" style="margin-top: 10px;
                        padding: 10px;
                        border-radius: 4px;
                        width: 250px;">  
                        <script>
